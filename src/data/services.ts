...
export const servicesData: ServiceItem[] = [
  {
    id: 'sheet-vinyl-coving',
    slug: 'sheet-vinyl-coving',
    title: 'Sheet Vinyl Coving & PVC Flooring',
    categoryTag: 'Commercial & Wet Areas',
    tagline: 'Seamless Hygienic Vinyl & Flash Coving Installation',
    shortDesc: 'Seamless sheet vinyl, PVC flooring, and flash coving for healthcare, commercial kitchens, bathrooms, and high-hygiene environments.',
    fullDesc: 'HD Flooring specializes in heat-welded sheet vinyl installation and wall flash coving. Essential for commercial spaces, medical facilities, restaurants, and residential bathrooms requiring 100% watertight, hygienic flooring.',
    heroImage: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&w=1200&q=80',
    benefits: [
      '100% Watertight heat-welded seams',
      'Integrated wall flash coving prevents moisture buildup',
      'Hygienic, anti-bacterial PVC surface',
      'Easy to sanitize and clean',
    ],
    options: ['Commercial PVC Sheet', 'Hygienic Wall Flash Coving', 'Heat Welded Seam Rods'],
    idealFor: ['Commercial Kitchens', 'Hospitals & Clinics', 'Bathrooms & Mudrooms', 'Veterinary Facilities'],
    process: ['Subfloor Moisture Test', 'Self-Leveling Compound', 'Adhesive Application', 'Flash Coving & Heat Welding'],
    faqs: [
      {
        question: 'What is flash coving?',
        answer: 'Flash coving extends sheet vinyl up the base of the wall (usually 4 to 6 inches), creating a seamless curved corner that eliminates dust and water traps.',
      },
    ],
  },
  {
    id: 'lvp-lvt-vct-vinyl',
    slug: 'lvp-lvt-vct-vinyl',
    title: 'LVP / LVT / VCT Luxury Vinyl',
    categoryTag: 'Vinyl Flooring',
    tagline: 'Waterproof Luxury Vinyl Planks, Tiles & Commercial VCT',
    shortDesc: '100% waterproof LVP, realistic stone LVT, and heavy-duty commercial VCT tile installation for active spaces.',
    fullDesc: 'Luxury Vinyl Plank (LVP), Luxury Vinyl Tile (LVT), and Vinyl Composition Tile (VCT) provide hyper-realistic wood and stone textures with total moisture immunity and scratch resistance.',
    ...
    options: ['Click-Lock LVP Planks', 'Glue-Down LVT Tiles', 'Commercial VCT Tiles'],
    idealFor: ['Kitchens & Basements', 'Retail Stores', 'Corporate Offices', 'Rental Properties'],
    process: ['Subfloor Prep', 'Underlayment Setup', 'Plank/Tile Setting', 'Perimeter Trimming'],
    faqs: [
      {
        question: 'What is the difference between LVP, LVT, and VCT?',
        answer: 'LVP mimics wood planks, LVT mimics ceramic or natural stone tiles, and VCT is durable vinyl composition tile commonly used in high-traffic commercial facilities.',
      },
    ],
  },
  {
  ...
  {
    id: 'tile-porcelain-flooring',
    slug: 'tile-porcelain-flooring',
  ...
  {
    id: 'flooring-repairs-replacement',
    slug: 'flooring-repairs-replacement',
