            ...
            {filteredProjects.map((project) => (
              ...
              >
                ...
                <div className="p-6 sm:p-8 space-y-4">
                  ...
                  <div className="pt-4 flex items-center justify-between border-t border-slate-100 dark:border-slate-800 font-manrope">
                    <Link
                      href={`/projects/${project.slug}`}
                      className="text-xs font-bold text-red-500 hover:text-red-400 flex items-center gap-1.5 group/link"
                    >
                      View Case Study
